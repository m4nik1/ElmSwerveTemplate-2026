...
public final class Constants {
    ...
    public static AprilTagFieldLayout fieldLayout = AprilTagFieldLayout.loadField(AprilTagFields.k2026RebuiltAndymark);
    ...
    // Translation3d of the inner center point of the hub
    public static final Translation3d HUB_BLUE_CENTER_POINT = new Translation3d(
